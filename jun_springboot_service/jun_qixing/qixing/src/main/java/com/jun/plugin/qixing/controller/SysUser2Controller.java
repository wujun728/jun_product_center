...
import com.jun.plugin.qixing.entity.SysUser2V2Entity;
...
public class SysUser2Controller {
    ...
    */
    ...
    @ResponseBody
    public DataResult add(@RequestBody SysUser2V2Entity sysUser2){
    ...
    @ResponseBody
    public DataResult update(@RequestBody SysUser2V2Entity sysUser2){
    ...
    @ResponseBody
    @DataScope
    public DataResult findListByPage(@RequestBody SysUser2V2Entity sysUser2){
        Page page = new Page(sysUser2.getPage(), sysUser2.getLimit());
        LambdaQueryWrapper<SysUser2V2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
        //queryWrapper.like(SysUser2Entity::getId, sysUser2.getId()==null?"":sysUser2.getId());
        IPage<SysUser2V2Entity> iPage = sysUser2Service.page(page, queryWrapper);
    ...
    @ResponseBody
    public DataResult listBySelect(@RequestBody SysUser2V2Entity sysUser2){
        Page page = new Page(sysUser2.getPage(), sysUser2.getLimit());
        LambdaQueryWrapper<SysUser2V2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
    ...
    @ResponseBody
    public DataResult findOne(@RequestBody SysUser2V2Entity sysUser2){
    	LambdaQueryWrapper<SysUser2V2Entity> queryWrapper = Wrappers.lambdaQuery();
    	//查询条件示例
    	//queryWrapper.eq(SysUser2Entity::getId, sysUser2.getId());
    	//SysUser2Entity one = sysUser2Service.getOne(queryWrapper);
    	SysUser2V2Entity one = sysUser2Service.getById(sysUser2.getId());
    ...
    @ResponseBody
    public DataResult findListBySelect(@RequestBody SysUser2V2Entity sysUser2){
        Page page = new Page(sysUser2.getPage(), sysUser2.getLimit());
        LambdaQueryWrapper<SysUser2V2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
        //queryWrapper.like(SysUser2Entity::getId, sysUser2.getId());
