...
public interface BizCommonMapper extends BaseMapper<BizCommonV2Entity> {
	...
	int insert(@Param("para") BizCommonV2Entity para);
...
//			+ "	-- d.ref_teamplate_name='（2021）年度部门负责人岗位职责考核标准';\r\n"
	...
	@Select(" WITH RECURSIVE temp AS (  \r\n"
			...
			+ ")select * from temp ")
	List<OaLawInfoV2Entity> queryOaLawInfoEntityTreeBypid(@Param("id") String id);
...
//	ALTER TABLE dim_date_tcl CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
	@Select(" SELECT user_name as 'value',nick_name as 'title' from sys_user ")
