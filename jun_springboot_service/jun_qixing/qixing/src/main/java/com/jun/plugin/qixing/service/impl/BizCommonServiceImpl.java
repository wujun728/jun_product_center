...
@Slf4j
public class BizCommonServiceImpl extends ServiceImpl<BizCommonMapper, BizCommonV2Entity> implements BizCommonService {
...
//			    	PjProjectReportEntity obj = pjProjectReportService.getById(businessId);
					...
					//***********************************更新报告记录表*******************************************11
					//@TODO 6666
					LambdaQueryWrapper<PjProjectReportnumberV2Entity> queryWrapper22 = Wrappers.lambdaQuery();
					queryWrapper22.eq(PjProjectReportnumberV2Entity::getId, obj.getId());
					PjProjectReportnumberV2Entity obj22 = pjProjectReportnumberService.getOne(queryWrapper22);
					if(obj22==null) {
						obj22 = new PjProjectReportnumberV2Entity();
					}
