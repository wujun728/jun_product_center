...
import com.jun.plugin.qixing.entity.PjProjectAppraiseV2Entity;
...
public class PjProjectAppraiseController {
    ...
    */
    ...
    @ResponseBody
    public DataResult add(@RequestBody PjProjectAppraiseV2Entity pjProjectAppraise){
    ...
    @ResponseBody
    public DataResult update(@RequestBody PjProjectAppraiseV2Entity pjProjectAppraise){
    ...
    @ResponseBody
    @DataScope
    public DataResult findListByPage(@RequestBody PjProjectAppraiseV2Entity pjProjectAppraise){
        Page page = new Page(pjProjectAppraise.getPage(), pjProjectAppraise.getLimit());
        LambdaQueryWrapper<PjProjectAppraiseV2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
        queryWrapper.like(PjProjectAppraiseV2Entity::getRefProjectName, pjProjectAppraise.getRefProjectName()==null?"":pjProjectAppraise.getRefProjectName());
        queryWrapper.like(PjProjectAppraiseV2Entity::getRefUsername, pjProjectAppraise.getRefUsername()==null?"":pjProjectAppraise.getRefUsername());
        if (!CollectionUtils.isEmpty(pjProjectAppraise.getCreateIds())) {
            queryWrapper.in(PjProjectAppraiseV2Entity::getCreateId, pjProjectAppraise.getCreateIds());
        }
        IPage<PjProjectAppraiseV2Entity> iPage = pjProjectAppraiseService.page(page, queryWrapper);
        List<PjProjectAppraiseV2Entity> records = iPage.getRecords();
    ...
    @ResponseBody
    @DataScope
    public DataResult listBySelect(@RequestBody PjProjectAppraiseV2Entity pjProjectAppraise){
        Page page = new Page(pjProjectAppraise.getPage(), pjProjectAppraise.getLimit());
        LambdaQueryWrapper<PjProjectAppraiseV2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
    ...
    @ResponseBody
    public DataResult findOne(@RequestBody PjProjectAppraiseV2Entity pjProjectAppraise){
    	LambdaQueryWrapper<PjProjectAppraiseV2Entity> queryWrapper = Wrappers.lambdaQuery();
    	//查询条件示例
    	...
    	PjProjectAppraiseV2Entity one = pjProjectAppraiseService.getById(pjProjectAppraise.getId());
    ...
    @ResponseBody
    @DataScope
    public DataResult findListBySelect(@RequestBody PjProjectAppraiseV2Entity pjProjectAppraise){
        Page page = new Page(pjProjectAppraise.getPage(), pjProjectAppraise.getLimit());
        LambdaQueryWrapper<PjProjectAppraiseV2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
        //queryWrapper.like(PjProjectAppraiseEntity::getId, pjProjectAppraise.getId());
