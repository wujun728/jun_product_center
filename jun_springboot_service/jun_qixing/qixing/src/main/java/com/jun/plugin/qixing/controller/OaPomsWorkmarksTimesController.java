...
import com.jun.plugin.qixing.entity.OaPomsWorkmarksTimesV2Entity;
...
public class OaPomsWorkmarksTimesController {
    ...
    */
    ...
    @ResponseBody
    public DataResult add(@RequestBody OaPomsWorkmarksTimesV2Entity oaPomsWorkmarksTimes){
    ...
    @ResponseBody
    public DataResult update(@RequestBody OaPomsWorkmarksTimesV2Entity oaPomsWorkmarksTimes){
    ...
    @ResponseBody
    @DataScope
    public DataResult findListByPage(@RequestBody OaPomsWorkmarksTimesV2Entity oaPomsWorkmarksTimes){
        Page page = new Page(oaPomsWorkmarksTimes.getPage(), oaPomsWorkmarksTimes.getLimit());
        LambdaQueryWrapper<OaPomsWorkmarksTimesV2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
        //queryWrapper.eq(OaPomsWorkmarksTimesEntity::getId, oaPomsWorkmarksTimes.getId());
        IPage<OaPomsWorkmarksTimesV2Entity> iPage = oaPomsWorkmarksTimesService.page(page, queryWrapper);
    ...
    @ResponseBody
    public DataResult findOne(@RequestBody OaPomsWorkmarksTimesV2Entity oaPomsWorkmarksTimes){
    	LambdaQueryWrapper<OaPomsWorkmarksTimesV2Entity> queryWrapper = Wrappers.lambdaQuery();
    	//查询条件示例
    	//queryWrapper.eq(OaPomsWorkmarksTimesEntity::getId, oaPomsWorkmarksTimes.getId());
    	//OaPomsWorkmarksTimesEntity one = oaPomsWorkmarksTimesService.getOne(queryWrapper);
    	OaPomsWorkmarksTimesV2Entity one = oaPomsWorkmarksTimesService.getById(oaPomsWorkmarksTimes.getId());
    ...
    @ResponseBody
    public DataResult findListBySelect(@RequestBody OaPomsWorkmarksTimesV2Entity oaPomsWorkmarksTimes){
        Page page = new Page(oaPomsWorkmarksTimes.getPage(), oaPomsWorkmarksTimes.getLimit());
        LambdaQueryWrapper<OaPomsWorkmarksTimesV2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
        //queryWrapper.eq(OaPomsWorkmarksTimesEntity::getId, oaPomsWorkmarksTimes.getId());
