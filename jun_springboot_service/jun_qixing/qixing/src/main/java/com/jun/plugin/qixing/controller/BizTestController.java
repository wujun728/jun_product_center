...
public class BizTestController {
    ...
    */
    ...
    @ResponseBody
    public DataResult add(@RequestBody BizTestV2Entity bizTest){
    ...
    @ResponseBody
    public DataResult update(@RequestBody BizTestV2Entity bizTest){
    ...
    @ResponseBody
    @DataScope
    public DataResult findListByPage(@RequestBody BizTestV2Entity bizTest){
        Page page = new Page(bizTest.getPage(), bizTest.getLimit());
        LambdaQueryWrapper<BizTestV2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
        //queryWrapper.eq(BizTestEntity::getId, bizTest.getId());
        IPage<BizTestV2Entity> iPage = bizTestService.page(page, queryWrapper);
    ...
    @ResponseBody
    public DataResult findOne(@RequestBody BizTestV2Entity bizTest){
    	LambdaQueryWrapper<BizTestV2Entity> queryWrapper = Wrappers.lambdaQuery();
    	//查询条件示例
    	//queryWrapper.eq(BizTestEntity::getId, bizTest.getId());
    	//BizTestEntity one = bizTestService.getOne(queryWrapper);
    	BizTestV2Entity one = bizTestService.getById(bizTest.getId());
    ...
    @ResponseBody
    public DataResult findListBySelect(@RequestBody BizTestV2Entity bizTest){
        Page page = new Page(bizTest.getPage(), bizTest.getLimit());
        LambdaQueryWrapper<BizTestV2Entity> queryWrapper = Wrappers.lambdaQuery();
        //查询条件示例
        //queryWrapper.eq(BizTestEntity::getId, bizTest.getId());
