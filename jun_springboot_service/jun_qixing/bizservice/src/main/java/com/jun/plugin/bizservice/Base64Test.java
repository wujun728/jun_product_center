...
public class Base64Test implements Serializable {
    public static void main(String[] args) throws IOException {

        File file = new File("C:\\Users\\whbj_wujun\\Desktop\\base64.txt");
        String content = FileUtils.readFileToString(file,StandardCharsets.UTF_8);
        //String content = "" + "";
        String compressStr = Base64Test.compressBase64(content,StandardCharsets.UTF_8.toString());
...
//        System.out.println(Base64.decodeGzipBase64(compressStr));
    ...
    public static String compressBase64(String str, String charset) throws IOException {
        ...
        try {
            ...
            String zipStr = Base64.encode(out.toByteArray());
            return zipStr;
        } catch (Exception e) {
