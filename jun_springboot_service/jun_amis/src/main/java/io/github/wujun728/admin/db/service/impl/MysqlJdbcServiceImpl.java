...
//    private LogService logService;
    ...
    public void insert(BaseData obj) {
        ...
        String tableName = StringUtil.toTableName(clzName);
    ...
    public void delete(BaseData obj) {
        ...
        String tableName = StringUtil.toTableName(obj.getClass().getSimpleName());
    ...
    public void delete(Long id, Class<? extends BaseData> clz) {
        ...
        String tableName = StringUtil.toTableName(clz.getSimpleName());
