...
public class LocalWaterUtil {
     ...
     * @throws Exception
     */
    public static String addWaterMark(String sourceFile, String waterContent, boolean isDelSourceFile) throws Exception {
        try {
            ...
            PdfReader reader = new PdfReader(EsignUtil.getAbsolutePath(sourceFile));
            PdfStamper stamper = new PdfStamper(reader, new FileOutputStream(absoluteFileUrl));
