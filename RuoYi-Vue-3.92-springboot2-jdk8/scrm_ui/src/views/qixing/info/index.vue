<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="pname">
        <el-input
      ...
      <el-form-item label="是否草稿" prop="dictIsDraft">
        <el-input
          v-model="queryParams.dictIsDraft"
          placeholder="请输入是否草稿"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="${comment}" prop="refSendDept">
        <el-input
          v-model="queryParams.refSendDept"
          placeholder="请输入${comment}"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="pname" />
      <el-table-column label="排序" align="center" prop="sortid" />
      <el-table-column label="发布信息类型" align="center" prop="dictMsgType" />
      <el-table-column label="是否草稿" align="center" prop="dictIsDraft" />
      <el-table-column label="发布人" align="center" prop="creator" />
      <el-table-column label="${comment}" align="center" prop="refSendDept" />
      <el-table-column label="发布时间" align="center" prop="publishDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.publishDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="失效时间" align="center" prop="invalidDate" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="pname">
          <el-input v-model="form.pname" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="排序" prop="sortid">
          <el-input v-model="form.sortid" placeholder="请输入排序" />
        </el-form-item>
        <el-form-item label="是否草稿" prop="dictIsDraft">
          <el-input v-model="form.dictIsDraft" placeholder="请输入是否草稿" />
        </el-form-item>
        <el-form-item label="发布人" prop="creator">
          <el-input v-model="form.creator" placeholder="请输入发布人" />
        </el-form-item>
        <el-form-item label="${comment}" prop="refSendDept">
          <el-input v-model="form.refSendDept" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="发布时间" prop="publishDate">
          <el-date-picker clearable
...
<script>
import { listInfo, getInfo, delInfo, addInfo, updateInfo } from "@/api/qixing/info";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除政策法规编号为"' + ids + '"的数据项？').then(function() {
        return delInfo(ids);
      }).then(() => {
        this.getList();
