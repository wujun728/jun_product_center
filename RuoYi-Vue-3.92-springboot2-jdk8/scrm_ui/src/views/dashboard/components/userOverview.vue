...
export default {
  ...
  methods: {
    ...
    //用户概览
    getUserView() {
      this.userView = { registerNum: 0, registerNumRatio: '0%', pageviews: 0, activeUserNum: 0, activeUserNumRatio: '0%', orderUserNum: 0, rechargeUserNum: 0, rechargeUserNumRatio: '0%', customerPrice: '0', orderPayUserNum: 0 };
    },
    getChannel() {
      this.optionData = {
        tooltip: { trigger: 'item' },
        legend: { orient: 'vertical', left: 'right' },
        series: [{ name: '访问来源', type: 'pie', radius: ['40%', '70%'], data: [{ name: '暂无', value: 1 }] }]
      };
    },
  },
};
