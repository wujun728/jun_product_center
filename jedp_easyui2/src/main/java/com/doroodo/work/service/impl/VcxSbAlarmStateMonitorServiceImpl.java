...
@Service("vcxSbAlarmStateMonitorService")
public class VcxSbAlarmStateMonitorServiceImpl extends BaseServiceImpl<VcxSbAlarmStateMonitor>  implements VcxSbAlarmStateMonitorService {
}