...
@Entity
@Table(name = "v_cx_sb_leakage_current_monitor")
public class VcxSbLeakageCurrentMonitor  extends BaseModel implements java.io.Serializable{
	...
	public VcxSbLeakageCurrentMonitor(){
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof VcxSbLeakageCurrentMonitor == false) return false;
		if(this == obj) return true;
		VcxSbLeakageCurrentMonitor other = (VcxSbLeakageCurrentMonitor)obj;
