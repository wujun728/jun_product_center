...
@Entity
@Table(name = "v_cx_sb_read_status")
public class VcxSbReadStatus  extends BaseModel implements java.io.Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof VcxSbReadStatus == false) return false;
		if(this == obj) return true;
		VcxSbReadStatus other = (VcxSbReadStatus)obj;
