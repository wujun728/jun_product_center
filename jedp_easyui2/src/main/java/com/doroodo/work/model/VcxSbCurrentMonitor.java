...
@Entity
@Table(name = "v_cx_sb_current_monitor")
public class VcxSbCurrentMonitor  extends BaseModel implements java.io.Serializable{
	...
	@Length(max=255)
	private java.lang.String acrrent;
	@Length(max=255)
	private java.lang.String bcrrent;
	@Length(max=255)
	private java.lang.String ccrrent;
	@Length(max=32)
	...
	@Column(name = "A_crrent", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	public java.lang.String getAcrrent() {
		return this.acrrent;
	}
	
	public void setAcrrent(java.lang.String value) {
		this.acrrent = value;
	}
	
	@Column(name = "B_crrent", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	public java.lang.String getBcrrent() {
		return this.bcrrent;
	}
	
	public void setBcrrent(java.lang.String value) {
		this.bcrrent = value;
	}
	
	@Column(name = "C_crrent", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	public java.lang.String getCcrrent() {
		return this.ccrrent;
	}
	
	public void setCcrrent(java.lang.String value) {
		this.ccrrent = value;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof VcxSbCurrentMonitor == false) return false;
		if(this == obj) return true;
		VcxSbCurrentMonitor other = (VcxSbCurrentMonitor)obj;
