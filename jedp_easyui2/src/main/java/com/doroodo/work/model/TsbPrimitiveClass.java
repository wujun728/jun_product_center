...
@Entity
@Table(name = "t_sb_primitive_class")
public class TsbPrimitiveClass  extends BaseModel implements java.io.Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof TsbPrimitiveClass == false) return false;
		if(this == obj) return true;
		TsbPrimitiveClass other = (TsbPrimitiveClass)obj;
