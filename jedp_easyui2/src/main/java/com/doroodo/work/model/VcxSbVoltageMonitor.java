...
@Entity
@Table(name = "v_cx_sb_voltage_monitor")
public class VcxSbVoltageMonitor  extends BaseModel implements java.io.Serializable{
	...
	@Length(max=255)
	private java.lang.String avoltage;
	@Length(max=255)
	private java.lang.String bvoltage;
	@Length(max=255)
	private java.lang.String cvoltage;
	@Length(max=32)
	...
	@Column(name = "A_voltage", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	public java.lang.String getAvoltage() {
		return this.avoltage;
	}
	
	public void setAvoltage(java.lang.String value) {
		this.avoltage = value;
	}
	
	@Column(name = "B_voltage", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	public java.lang.String getBvoltage() {
		return this.bvoltage;
	}
	
	public void setBvoltage(java.lang.String value) {
		this.bvoltage = value;
	}
	
	@Column(name = "C_voltage", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	public java.lang.String getCvoltage() {
		return this.cvoltage;
	}
	
	public void setCvoltage(java.lang.String value) {
		this.cvoltage = value;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof VcxSbVoltageMonitor == false) return false;
		if(this == obj) return true;
		VcxSbVoltageMonitor other = (VcxSbVoltageMonitor)obj;
