...
@Entity
@Table(name = "sy_sb_primitive")
public class SySbPrimitive  extends BaseModel implements java.io.Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof SySbPrimitive == false) return false;
		if(this == obj) return true;
		SySbPrimitive other = (SySbPrimitive)obj;
