...
@Entity
@Table(name = "sy_sysdomain")
public class SySysdomain  extends BaseModel implements java.io.Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof SySysdomain == false) return false;
		if(this == obj) return true;
		SySysdomain other = (SySysdomain)obj;
