...
<html>
  <head>
	...
	<script type="text/javascript">
		$(function(){
	        <%-- Mock.mock('<%=basePath%>system/findAllFunctionList',
	        ...
	        Mock.mock('functionAction!findAllFunctionList',
	...
	<script type="text/javascript">
		...
		function initMenu(){
			...
			$.post("<%=basePath%>system/findAllFunctionList", {userName:"1"}, function(rsp) {
