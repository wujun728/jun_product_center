...
public class SupServiceImpl implements SupService
{
	...
	/* (非 Javadoc) 
	* <p>Title: findSuplierContactList</p> 
	* <p>Description:查询供应商联系人 </p> 
	* @param SuplierId
	* @return 
	...
	*/
	...
	/* (非 Javadoc) 
	* <p>Title: persistenceSuplier</p> 
	* <p>Description: 持久化Suplier和持久化关联的 SuplierContact</p> 
	* @param c
	* @param map
	* @return 
	...
	*/
	...
	/* (非 Javadoc) 
	* <p>Title: delSuplier</p> 
	* <p>Description: 删除供应商以及关联联系人</p> 
	* @param customerId
	* @return 
