<template>
  <div class="app-container">
    ...
    <el-table stripe border v-loading="loading" class="tableClass"  :data="jobList" @selection-change="handleSelectionChange">
    ...
    <!-- 添加或修改定时任务对话框 -->
    <el-dialog v-drag-dialog="true" :title="title" :visible.sync="open" width="800px" append-to-body>
    ...
    <el-dialog v-drag-dialog="true" title="Cron表达式生成器" :visible.sync="openCron" append-to-body destroy-on-close
               class="scrollbar">
      <crontab @hide="openCron=false" @fill="crontabFill" :expression="expression"></crontab>
    </el-dialog>

    <!-- 任务日志详细 -->
    <el-dialog v-drag-dialog="true" title="任务详细" :visible.sync="openView" width="700px" append-to-body>
