<template>
  <div class="app-container">
    ...
    <el-table stripe border ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange"
    ...
    <!-- 操作日志详细 -->
    <el-dialog v-drag-dialog="true" title="操作日志详细" :visible.sync="open" width="800px" append-to-body>
