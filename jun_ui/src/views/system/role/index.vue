<template>
  <div class="app-container">
    ...
    <el-table stripe border v-loading="loading" class="tableClass"   :data="roleList" @selection-change="handleSelectionChange">
    ...
    <!-- 分配角色数据权限对话框 -->
    <el-dialog v-drag-dialog="true" :title="title" :visible.sync="openDataScope" width="500px" append-to-body>
