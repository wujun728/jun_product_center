<template>
  <div class="panel-tab__content">
    ...
    <div class="element-property list-property">
      ...
      <el-table stripe border :data="fieldList" size="mini" max-height="240" border fit>
    ...
    <el-drawer :visible.sync="fieldModelVisible" title="字段配置" :size="`${width}px`" append-to-body destroy-on-close>
      ...
      <template v-if="formFieldForm.type === 'enum'">
        ...
        <el-table stripe border :data="fieldEnumList" size="mini" key="enum-table" max-height="240" border fit>
      ...
      <el-table stripe border :data="fieldConstraintsList" size="mini" key="validation-table" max-height="240" border fit>
        <el-table-column label="序号" width="50px" type="index" />
      ...
      <el-table stripe border :data="fieldPropertiesList" size="mini" key="property-table" max-height="240" border fit>
        <el-table-column label="序号" width="50px" type="index" />
    ...
    <el-dialog v-drag-dialog="true" :visible.sync="fieldOptionModelVisible" :title="optionModelTitle" width="600px" append-to-body destroy-on-close>
