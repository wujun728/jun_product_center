<template>
  <div class="panel-tab__content">
    <el-table stripe border :data="elementListenersList" size="mini" border>
    ...
    <el-drawer :visible.sync="listenerFormModelVisible" title="执行监听器" :size="`${width}px`" append-to-body destroy-on-close>
      ...
      <el-table stripe border :data="fieldsListOfListener" size="mini" max-height="240" border fit style="flex: none">
        <el-table-column label="序号" width="50px" type="index" />
    ...
    <!-- 注入西段 编辑/创建 部分 -->
    <el-dialog v-drag-dialog="true" title="字段配置" :visible.sync="listenerFieldFormModelVisible" width="600px" append-to-body destroy-on-close>
