<template>
  <div class="panel-tab__content">
    ...
    <el-table stripe border :data="messageList" size="mini" border>
    ...
    <el-table stripe border :data="signalList" size="mini" border>
      <el-table-column type="index" label="序号" width="60px" />
    ...
    <el-dialog v-drag-dialog="true" :visible.sync="modelVisible" :title="modelConfig.title" :close-on-click-modal="false" width="400px" append-to-body destroy-on-close>
