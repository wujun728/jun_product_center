<template>
  <div class="panel-tab__content">
    <el-table stripe border :data="elementPropertyList" size="mini" max-height="240" border fit>
    ...
    <el-dialog v-drag-dialog="true" :visible.sync="propertyFormModelVisible" title="属性配置" width="600px" append-to-body destroy-on-close>
