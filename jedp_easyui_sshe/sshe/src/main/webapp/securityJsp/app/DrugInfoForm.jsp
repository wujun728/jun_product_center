		...
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				...
				<tr>
					<th>简称</th>
					<td>
						<input name="data.shortName" class="easyui-validatebox" data-options="required:true" />
					</td>
					<th></th>
					<td>
					</td>
				...
				<tr>
					<th>药品描述</th>
					<td colspan="3"><textarea name="data.drugDesc" cols="100" class="easyui-validatebox" data-options="required:true"></textarea></td>
				</tr>
				<!-- <tr>
					<th>生产厂商</th>
					<td>
