...
<script type="text/javascript">
	...
	var addFun = function() {
		var dialog = parent.sy.modalDialog({
			title : '添加体检信息',
			url : sy.contextPath + '/securityJsp/app/MedicalDetailForm.jsp?oType=TJ_REPORT_TYPE_ZY_RZ',
			buttons : [ {
				text : '添加',
				handler : function() {
	...
	var addFunRe = function(id) {
		var dialog = parent.sy.modalDialog({
			title : '添加体检信息',
			url : sy.contextPath + '/securityJsp/app/MedicalDetailForm.jsp?oType=TJ_REPORT_TYPE_ZY_RZ&data_empMedicalDetail_id=' + id ,
			buttons : [ {
				text : '添加',
				handler : function() {
					dialog.find('iframe').get(0).contentWindow.submitForm(
	...
	var showFun = function(id) {
		var dialog = parent.sy.modalDialog({
			title : '查看体检信息',
			url : sy.contextPath + '/securityJsp/app/MedicalDetailForm.jsp?oType=TJ_REPORT_TYPE_ZY_RZ&id=' + id
		});
	};
	...
	var editFun = function(id) {
		var dialog = parent.sy
				.modalDialog({
					title : '编辑体检信息',
					url : sy.contextPath
							+ '/securityJsp/app/MedicalDetailForm.jsp?oType=TJ_REPORT_TYPE_ZY_RZ&id=' + id,
					buttons : [ {
						text : '编辑',
						handler : function() {
	...
	$(function() {
		...
		medicalTypeCombox= $('#medicalTypeCombox').combobox({
	        url:'<%=contextPath%>/base/sys-def!doNotNeedSecurity_getSubListByType.sy?type=TJ_REPORT_TYPE_ZY_RZ',
	        idField:'id',
	        valueField:'id',
	        textField:'text',
	        parentField:'pid',
		...
		grid = $('#grid').treegrid(
				{
					title : '',
					url : sy.contextPath + '/app/medical-detail!grid.sy?data.medicalType=10104105',
					striped : true,
					rownumbers : true,
					pagination : true,
					singleSelect : true,
