	...
	<form method="post" class="form">
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				...
				<tr>
					<th>描述</th>
					<td colspan="3"><textarea name="data.defDesc" class="easyui-validatebox"  cols="100" data-options="required:true" ></textarea></td>
				</tr>
				<tr>
					<th>类型</th>
