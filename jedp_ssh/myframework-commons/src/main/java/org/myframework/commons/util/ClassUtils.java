...
public abstract class ClassUtils {
	...
	public static Method getMostSpecificMethod(Method method, Class<?> targetClass) {
		...
		if (method != null && isOverridable(method, targetClass) &&
			...
			specificMethod = ReflectUtils.getAccessibleMethod(targetClass, method.getName(), method.getParameterTypes());
		}
	 ...
	 * although {@link org.myframework.commons.util.io.springframework.core.io.ClassPathResource} is usually
