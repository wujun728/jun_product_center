...
public class SysUserController extends BaseController
{
    ...
    public R getInfo(@PathVariable(value = "userId", required = false) Long userId)
    {
        ...
        r.put("roles", SysUser.isAdmin(userId) ? roles : roles.stream().filter(role -> !role.isAdmin()).collect(Collectors.toList()));
        r.put("posts", postService.selectPostAll());
        if (StringUtils.isNotNull(userId))
        {
            r.put(R.DATA_TAG, userService.selectUserById(userId));
            r.put("postIds", postService.selectPostListByUserId(userId));
