...
public abstract class ImageUtils {
	...
	public static final String[] IMAGE_EXT = new String[] { "jpg", "jpeg",
			"gif", "png", "bmp" };
	public static final String[] IMAGE_EXT1 = new String[] { "jpg", "jpeg", "png"};
	/**
	 * 是否是图片
	 * 
	 * @param ext
	 ...
	 */
	public static boolean isGifImageExt(String ext) {
	 ...
	 * 
	 * @param ext
	 * @return "jpg", "jpeg", "png",  为文件后缀名者为图片
	 */
	public static boolean isImageExtZip(String ext) {
		ext = ext.toLowerCase(Locale.ENGLISH);
		for (String s : IMAGE_EXT1) {
