        ...
        <el-col :span="18">
          <div class="grid-content bg-purple">
            <el-card class="box-card">
              <div id="myChart" :style="{width: '100%px', height: '350px'}"></div>
            </el-card>
          </div>
        </el-col>
        <el-col :span="6">
