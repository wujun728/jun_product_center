...
const Page404 = () => import('/page/404.vue')
...
let routes= [
    ...
    //     {
    //       path: 'list',
    //       component: () => import('@/page/app/list'),
    //       name: '应用管理',
    ...
    //     {
    //       path: 'list',
    //       component: () => import('@/page/dictionaryCtg/list'),
    //       name: '字典管理',
    ...
    //     {
    //       path: 'list',
    //       component: () => import('@/page/dictionary/list'),
    //       name: '字典代码',
    //       meta: { title: '字典管理列表', icon: 'list' }
    //     }
    //   ]
    ...
    //     {
    //       path: 'list',
    //       component: () => import('@/page/menu/list'),
    //       name: '菜单管理',
    ...
    //     {
    //       path: 'list',
    //       component: () => import('@/page/role/list'),
    //       name: '角色管理',
    ...
    //     {
    //       path: 'list',
    //       component: () => import('@/page/unifiedUser/list'),
    //       name: '用户管理',
    ...
    //     {
    //       path: 'list',
    //       component: () => import('@/page/systemLog/list'),
    //       name: '系统日志',
