...
const CODEMAP = JSON.parse(sessionStorage.getItem('login-user')).codeMap;
...
export default config({
  ...
  const [expert, expertUsers] = props.ajax.usePost(`${CODEMAP.t_user_export}`, { successTip: '导出成功，请耐心等待下载！' });
  const [template, templateUsers] = props.ajax.usePost(`${CODEMAP.t_user_import_template}`, { successTip: '下载成功，请耐心等待下载！' });
