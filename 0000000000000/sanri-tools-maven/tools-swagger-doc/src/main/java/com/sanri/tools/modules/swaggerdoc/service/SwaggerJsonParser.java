...
public class SwaggerJsonParser {
    ...
    public Doc doc(String url) throws IOException {
        ...
        Map<String, Object> resultFromString = getResultFromString(tables, data);
        String infoStr = JsonUtils.writeJsonStr(resultFromString.get("info"));
        Info info = JsonUtils.readValue(infoStr, Info.class);
        return new Doc(info,tables);
    }

    public Map<String, Object> getResultFromString(List<Table> result, String jsonStr) throws IOException {
