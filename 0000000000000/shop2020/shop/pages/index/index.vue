	...
	<view class="container">
		...
		<view class="carousel-section">
			...
			<swiper class="carousel" circular @change="swiperChange">
				<swiper-item v-for="(item, index) in adList" :key="index" class="carousel-item">
	...
	export default {
		...
		methods: {
				...
				this.sendRequest({
					...
					method : "get",
 					success:function (res) {
						_this.navList=res.data.navList;
 						let adList= res.data.adList;
						_this.swiperLength = adList.length;
						_this.adList = adList; 
 					}
				});   
 				this.sendRequest({
			...
			swiperChange(e) {
				...
				// this.titleNViewBackground = this.adList[index].background;
			},
			//详情页
