...
public class NoticeAct {
	...
	public @ResponseBody Object v_list(String name, Integer pageNo, Integer pageSize, HttpServletRequest request,
		...
		Pagination pagination = noticeService.getPage(name, cpn(pageNo), pageSize);
	...
	public @ResponseBody Object o_save(@RequestBody Notice bean) {
 		noticeService.save(bean);
		return new JsonResult(ResultCode.SUCCESS, true);
	}

	@RequestMapping(value = "/update", method = RequestMethod.POST)
	public @ResponseBody Object o_update(@RequestBody Notice bean) {
