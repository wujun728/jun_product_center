...
import io.github.wujun728.generator.entity.ColumnEntity;
import io.github.wujun728.generator.entity.TableEntity;
...
public class GenUtils {
    ...
    public static Map<String, String>  generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip,Boolean isView) {
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "io.github.wujun728" : mainPath;
        //封装模板数据
