...
<%-- 引入自定义样式 --%>
<link id="myeasyuiTheme"  rel="stylesheet" href="<%=contextPath%>/style/<%=easyuiTheme%>/syExtCss.css?version=<%=version%>" type="text/css">

<%-- 引入javascript扩展 --%>
<script src="<%=contextPath%>/jslib/syExtJavascript.js?version=<%=version%>" type="text/javascript" charset="utf-8"></script>

<%-- 引入javascript工具--%>
<script src="<%=contextPath%>/jslib/tool/sysCommonTool.js?version=<%=version%>" type="text/javascript" charset="utf-8"></script>

<%-- 引入javascript工具--%>
<script src="<%=contextPath%>/jslib/json2.js?version=<%=version%>" type="text/javascript" charset="utf-8"></script>

<%-- 引入javascript工具--%>
<script src="<%=contextPath%>/jslib/module/common.js?version=<%=version%>" type="text/javascript" charset="utf-8"></script>
