	...
	<form method="post" class="form">
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				<tr>
					<th>属性编号</th>
					<td><input name="data.attrId" value="<%=id%>"  disabled="disabled"  readonly="readonly" /></td>
					<th>体检报告</th>
				...
				<tr>
					<th>属性单位</th>
					<td>
						<select id="data.attrUnit" name="data.attrUnit" class="easyui-combotree" data-options="editable:false,idField:'id',textField:'text',parentField:'pid',url:'<%=contextPath%>/base/sys-def!doNotNeedSecurity_getAllListByType.sy?type=ATTR_UNIT'" style="width: 155px;"></select><img class="iconImg ext-icon-cross" onclick="$('#data.attrUnit').combotree('clear');" title="清空" />
					</td>
					<th>属性数值</th>
					<td><input name="data.unitData" class="easyui-validatebox"  maxlength="80"  data-options="required:false" /></td>
				</tr>
				<tr>
					<th>是否指标</th>
					<td><select class="easyui-combobox" name="data.isIndicators" data-options="panelHeight:'auto',editable:false" style="width: 155px;">
							<option value="1">指标属性</option>
							<option value="2">非指标属性</option>
						</select>
					</td>
					<th></th>
					<td></td>
