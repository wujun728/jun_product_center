...
<script type="text/javascript">
	...
	var addFun = function() {
		var dialog = parent.sy.modalDialog({
			title : '添加体检信息',
			url : sy.contextPath + '/securityJsp/app/MedicalDetailForm.jsp',
			buttons : [ {
				text : '添加',
				handler : function() {
	...
	var showFun = function(id) {
		var dialog = parent.sy.modalDialog({
			title : '查看体检信息',
			url : sy.contextPath + '/securityJsp/app/MedicalDetailForm.jsp?id=' + id
		});
	};
	...
	var editFun = function(id) {
		var dialog = parent.sy
				.modalDialog({
					title : '编辑体检信息',
					url : sy.contextPath
							+ '/securityJsp/app/MedicalDetailForm.jsp?id=' + id,
					buttons : [ {
						text : '编辑',
						handler : function() {
	...
	$(function() {
		...
		grid = $('#grid').datagrid(
				{
					title : '',
					url : sy.contextPath + '/app/medical-detail!grid.sy',
					striped : true,
					rownumbers : true,
					pagination : true,
					singleSelect : true,
						...
						<table>
							<tr>
								...
								<td>
									...
									<select id="medicalTypeCombox" name="QUERY_t#medicalType_I_EQ" class="easyui-combotree"  style="width: 155px;"></select><img class="iconImg ext-icon-cross" onclick="$('#data.sysDef.sysCode').combotree('clear');" title="清空" />
								</td>
								<td>体检时间</td>
