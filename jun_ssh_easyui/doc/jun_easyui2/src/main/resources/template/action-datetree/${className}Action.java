...
public class ${className}Action extends BaseAction{
	...
	public void ${classNameLower}List(){
		this.writeJson(${classNameLower}Service.treeGrid(this.getPage(), this.getRows(), this.getSearchName(), this.getSearchKey(),this.getYear()));
	}
	
	@Action("/sys/${classNameLower}_List_tree")
	public void ${classNameLower}List_tree(){
		this.writeJson(${classNameLower}Service.listByDate(this.getYear()));
	}
