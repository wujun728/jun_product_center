...
@Service("vcxSbLeakageCurrentService")
public class VcxSbLeakageCurrentServiceImpl extends BaseServiceImpl<VcxSbLeakageCurrent>  implements VcxSbLeakageCurrentService {
}