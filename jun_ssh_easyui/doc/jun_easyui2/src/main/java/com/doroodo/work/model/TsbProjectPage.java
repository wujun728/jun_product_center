...
@Entity
@Table(name = "t_sb_project_page")
public class TsbProjectPage  extends BaseModel implements java.io.Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof TsbProjectPage == false) return false;
		if(this == obj) return true;
		TsbProjectPage other = (TsbProjectPage)obj;
