...
@Entity
@Table(name = "v_cx_sb_alarm_state_monitor")
public class VcxSbAlarmStateMonitor  extends BaseModel implements java.io.Serializable{
	...
	@Column(name = "msg_desc", unique = false, nullable = true, insertable = true, updatable = true, length = 32)
	public java.lang.String getMsgDesc() {
		return this.msgDesc;
	}
	
	public void setMsgDesc(java.lang.String value) {
		this.msgDesc = value;
	}
