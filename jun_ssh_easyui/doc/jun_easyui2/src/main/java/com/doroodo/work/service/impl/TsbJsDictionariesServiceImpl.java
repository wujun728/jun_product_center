...
@Service("tsbJsDictionariesService")
public class TsbJsDictionariesServiceImpl extends BaseServiceImpl<TsbJsDictionaries>  implements TsbJsDictionariesService {
}