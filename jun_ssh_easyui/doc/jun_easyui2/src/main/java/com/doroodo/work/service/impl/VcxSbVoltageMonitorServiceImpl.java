...
@Service("vcxSbVoltageMonitorService")
public class VcxSbVoltageMonitorServiceImpl extends BaseServiceImpl<VcxSbVoltageMonitor>  implements VcxSbVoltageMonitorService {
}