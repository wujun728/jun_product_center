...
@Service("tsbPrimitiveClassService")
public class TsbPrimitiveClassServiceImpl extends BaseServiceImpl<TsbPrimitiveClass>  implements TsbPrimitiveClassService {
}