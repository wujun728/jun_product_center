                    ...
                    <div class="blog-card blog-card-padding shadow">
                        <fieldset class="layui-elem-field layui-field-title" style="margin-bottom:0">
                            ...
                            <div class="layui-field-box">
                                <form class="layui-form blog-editor" action="${pageContext.request.contextPath}/comment/save.do">
                                    <div class="layui-form-item">
                                        <textarea name="remarkEditor" lay-verify="content" id="remarkEditor"
                                    ...
                                    <div class="verCode">
										...
										<input type="hidden" value="${blog.id}" name="blog.id"  id="blog.id" /> 
									</div>
                                    <div class="layui-form-item">
                        ...
                        <c:choose>
							<c:when test="${commentListCount==0}">
								暂无评论
							</c:when>
							<c:otherwise>
                ...
                , reword: function () {
                    layer.tab({
                        ...
                        tab: [{
                            ...
                            title: '支付宝',
                            content: '<img style="width:330px;height:330px;" src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/res/images/ali_reward.jpg" />'
                        }]
                    });
