mbui.define([], function (exports) {
	$('body').append('<div class="mbui-fixed-bar">\
			...
			<div class="fixed-bar-item">\
				<a href="/qiye/index/index.html">工作台</a>\
				<a href="/qiye/customer/index.html">客户<br>管理</a>\
				<a href="/qiye/contract/index.html">合同<br>管理</a>\
				<a href="/qiye/project/index.html">项目<br>管理</a>\
				<a href="/qiye/msg/index.html">消息<br>通知</a>\
			</div>\
		</div>');
