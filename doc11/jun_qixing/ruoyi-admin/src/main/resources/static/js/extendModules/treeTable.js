...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports){
	...
	var $ = layui.$
		...
		//字符常量
		,MOD_NAME = 'treeTable', ELEM = '.layui-table', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide', DISABLED = 'layui-disabled', NONE = 'layui-none'
	...
	Class.prototype.resizeHeight = function(){
		...
		bodyHeight = parseFloat(height) - theader - 3;//###注意：现在写死表头固定高度为38px，即不支持多表头方式（在tab方式下无法获取正确的高度，待处理）
		if(options.toolbar){
