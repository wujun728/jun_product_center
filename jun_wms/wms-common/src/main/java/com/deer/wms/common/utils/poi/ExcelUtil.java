package com.deer.wms.common.utils.poi;

import com.deer.wms.common.annotation.Excel;
import com.deer.wms.common.annotation.Excel.Type;
...
import com.deer.wms.common.utils.reflect.ReflectUtils;
    ...
    public AjaxResult exportExcel()
    {
        ...
        try
        {
            ...
            for (int index = 0; index <= sheetNo; index++)
            {
                ...
                CellRangeAddress cra=new CellRangeAddress(0, 0, 0, fields.size()-1);
                ...
                Font fontOne = wb.createFont();
                // 粗体显示
                fontOne.setBold(true);
                fontOne.setFontHeightInPoints((short) 40);
                // 选择需要用到的字体格式
                cellStyleOne.setFont(fontOne);
//                cellStyleOne.setFillForegroundColor(HSSFColorPredefined.LIGHT_YELLOW.getIndex());
                // 设置列宽
//                rowOne.setHeight((short) 1000);
                rowOne.setHeightInPoints(50);
                ...
                for (int i = 0; i < fields.size(); i++)
                {
                    ...
                    else
                    {
                        ...
                        // 设置列宽
                        sheet.setColumnWidth(i, (int) ((attr.width() + 0.72) * 300));
                    ...
                    if((fields.size()-2) == i){
                        cellTwo = rowTwo.createCell(i);
                        cellTwo.setCellValue("导出日期");
                    }
                    if((fields.size()-1) == i){
                        cellTwo = rowTwo.createCell(i);
                        cellTwo.setCellValue(DateUtils.getDate());
                    }
                    // 如果设置了提示信息则鼠标放上去提示.
