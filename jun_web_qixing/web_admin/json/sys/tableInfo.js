                ...
                "buttons": [
                    {
                        ...
                        "label": "一键生成(New)",
                        //"disabledOn": "tableName=='test'",
                        "confirmText": "确定生成${oldTableName},页面,表单,菜单?存在会替换",
                        "api": "/tableInfo/oneTouchNew?tableName=${oldTableName}"
                    }, 
                    {
                        "label": "列表配置",
                        "type": "button",
                        ...
                        "dialog": {
                            ...
                            "body":{
                                "type":"iframe",
                                "src":"/admin/page/pageEdit.html?id=${moduleName}",
                                "height":"calc( 100% - 10px )"
                            },
                            "actions":[]
                        }
                    },
                    {
                        ...
                        "dialog": {
                            ...
                            "body":{
                                "type":"iframe",
                                "src":"/admin/page/formEdit.html?id=${moduleName}",
                                "height":"calc( 100% - 10px )"
                            },
                            "actions":[]
                        }
