...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements ISysMenuService
{
    ...
    public List<SysMenu> selectMenuList(SysMenu menu, Long userId)
    {
        ...
        {
            if(CollectionUtil.isNotEmpty(menu.getParams())){
    ...
    public List<SysMenu> selectMenuTreeByUserId(Long userId)
    {
        ...
        {
            menus = menuMapper.selectList(new QueryWrapper<SysMenu>().lambda().in(SysMenu::getMenuType, UserConstants.TYPE_DIR, UserConstants.TYPE_MENU).eq(SysMenu::getStatus, UserConstants.NORMAL).orderByAsc(SysMenu::getParentId, SysMenu::getOrderNum));
        }
        else
        {
