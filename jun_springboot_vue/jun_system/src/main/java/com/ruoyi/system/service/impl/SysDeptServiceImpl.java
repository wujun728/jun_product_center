...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    public boolean checkDeptNameUnique(SysDept dept)
    {
        ...
        SysDept info = deptMapper.selectOne(new QueryWrapper<SysDept>().lambda().eq(SysDept::getDeptName, dept.getDeptName()).eq(SysDept::getParentId, dept.getParentId()));
    ...
    private void updateParentDeptStatusNormal(SysDept dept)
    {
        ...
        deptMapper.update(new SysDept(), new UpdateWrapper<SysDept>().lambda().set(SysDept::getStatus, dept.getStatus()).in(SysDept::getDeptId, dept.getAncestors().split(",")));
    }
    ...
    {
        List<SysDept> children = deptMapper.selectList(new QueryWrapper<SysDept>().lambda().likeLeft(SysDept::getAncestors, deptId));
