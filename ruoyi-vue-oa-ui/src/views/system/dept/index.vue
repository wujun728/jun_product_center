        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="机构简称" prop="simpleName">
              <el-input v-model="form.simpleName" placeholder="请输入机构简称" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="机构类型" prop="orgType">
              <template>
                <el-select v-model="form.orgType" placeholder="请选择机构类型" clearable>
                  <el-option v-for="dict in dict.type.sys_org_type" :key="dict.value" :label="dict.label" :value="dict.value" />
                </el-select>
              </template>
            </el-form-item>
          </el-col>
