<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="岗位编码" align="center" prop="postCode" width="120" />
      <el-table-column label="岗位名称" align="center" prop="postName" width="200" show-overflow-tooltip />
      <el-table-column label="岗位排序" align="center" prop="postSort" width="120" />
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_normal_disable" :value="scope.row.status" width="120" />
        </template>
      </el-table-column>
